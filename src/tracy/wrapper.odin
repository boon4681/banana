...
// The vendored client is compiled with -DTRACY_NO_CALLSTACK, so the ___tracy_*_callstack symbols do not exist and
// defaulting this to true would fail to link.
