...
style_vtable := Style_VTable{
    ...
    get_align_content   = proc(self: ^Style) -> Align { return YG.NodeStyleGetAlignContent(self.owner.raw) },
    get_align_items     = proc(self: ^Style) -> Align { return YG.NodeStyleGetAlignItems(self.owner.raw) },
    get_align_self      = proc(self: ^Style) -> Align { return YG.NodeStyleGetAlignSelf(self.owner.raw) },
    ...
    get_overflow_y   = proc(self: ^Style) -> Overflow { return _stored(self).overflow_y },
    get_box_sizing   = proc(self: ^Style) -> BoxSizing { return YG.NodeStyleGetBoxSizing(self.owner.raw) },
    get_flex         = proc(self: ^Style) -> f32 { return YG.NodeStyleGetFlex(self.owner.raw) },
    get_flex_grow    = proc(self: ^Style) -> f32 { return YG.NodeStyleGetFlexGrow(self.owner.raw) },
    get_flex_shrink  = proc(self: ^Style) -> f32 { return YG.NodeStyleGetFlexShrink(self.owner.raw) },
    get_aspect_ratio = proc(self: ^Style) -> f32 { return YG.NodeStyleGetAspectRatio(self.owner.raw) },

    get_width      = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetWidth(self.owner.raw); return r.value, r.unit },
    get_height     = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetHeight(self.owner.raw); return r.value, r.unit },
    get_min_width  = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetMinWidth(self.owner.raw); return r.value, r.unit },
    get_min_height = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetMinHeight(self.owner.raw); return r.value, r.unit },
    get_max_width  = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetMaxWidth(self.owner.raw); return r.value, r.unit },
    get_max_height = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetMaxHeight(self.owner.raw); return r.value, r.unit },
    get_flex_basis = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetFlexBasis(self.owner.raw); return r.value, r.unit },

    get_margin_left       = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetMargin(self.owner.raw, .Left); return r.value, r.unit },
    get_margin_top        = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetMargin(self.owner.raw, .Top); return r.value, r.unit },
    get_margin_right      = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetMargin(self.owner.raw, .Right); return r.value, r.unit },
    ...
    get_padding_top        = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetPadding(self.owner.raw, .Top); return r.value, r.unit },
    get_padding_right      = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetPadding(self.owner.raw, .Right); return r.value, r.unit },
    ...
    get_position_top        = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetPosition(self.owner.raw, .Top); return r.value, r.unit },
    get_position_right      = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetPosition(self.owner.raw, .Right); return r.value, r.unit },
    ...
    get_border_top        = proc(self: ^Style) -> f32 { return YG.NodeStyleGetBorder(self.owner.raw, .Top) },
    get_border_right      = proc(self: ^Style) -> f32 { return YG.NodeStyleGetBorder(self.owner.raw, .Right) },
    ...
    get_gap_row    = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetGap(self.owner.raw, .Row); return r, px },
    get_gap_all    = proc(self: ^Style) -> (f32, unit) { r := YG.NodeStyleGetGap(self.owner.raw, .All); return r, px },

    get_color       = proc(self: ^Style) -> Color { return Resolve_Text_Style(self.owner).color },
